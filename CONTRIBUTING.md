...
### TypeScript (`@journal-labs/bastion`)

```typescript
import { BastionServer } from "@journal-labs/bastion/hub";
...
One publishable package, `@journal-labs/bastion`, carrying the CLI (`.`), the hub
