...
import type { BastionConfig, IntegrationProvider, BastionVersions, Skill } from "../../protocol/index.js";
...
describe("BastionConnection", () => {
  ...
  it("sends tool_error for unknown integration", async () => {
    ...
    (provider.callTool as ReturnType<typeof vi.fn>).mockRejectedValue(
      new (await import("../../protocol/index.js")).IntegrationNotFoundError("unknown")
    );
