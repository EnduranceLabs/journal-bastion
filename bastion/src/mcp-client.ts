...
import { ContentBlockSchema, type ToolDefinition, type ToolResult, type ContentBlock } from "journal-bastion-protocol";
...
export class McpClient extends EventEmitter<McpClientEvents> {
  ...
  async start(): Promise<void> {
    ...
    this.client = new Client(
      { name: `journal-bastion/${this.definition.id}`, version: VERSION },
      { capabilities: {} }
    );
