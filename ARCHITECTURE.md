...
- `protocol/` — the `@journal/journal-bastion/protocol` package: pure Zod schemas and
...
- `src/hub/` — the `@journal/journal-bastion/hub` subpath export. Implements the
...
- `hub/python/` — the `@journal/journal-bastion` PyPI package. The same
